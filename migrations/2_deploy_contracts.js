...
var Ticket = artifacts.require("../contracts/TicketLib.sol");
...
async function doDeploy(deployer, network){
    ...
    await deployer.link(ArrayUtil, [Event, TicketChain, Ticket]);
    await deployer.deploy(Ticket);
    await deployer.link(Ticket, [Event, TicketChain]);
